 ...
 * @param  {string[]} media list of moonscannerAI media scanner prefixes
 * @return {RegExp}       Regular expression with moonscannerAI media scanner
 */
...
function Scanner(url) {
  ...
  let _on = {
     ...
     * @param {string[]} all_media A list of all links to moonscannerAI media scanner found
  ...
  /**
   * @return {string[]} List of prefixes for moonscannerAI media scanner links
   */
